...
```json
{
    "search": {
        ...
        "steps": [
            {
                "command": "open",
                "target": "http://127.0.0.1:8101/fetch/https://www.books.com.tw/products/##searchkey##",
                "value": "",
                "options": {}
            }
        ]
...
**改動只有一行：在 `target` 的 URL 前面加上 `http://127.0.0.1:8101/fetch/`**

**運作原理：**

```
HyFSE (driver: curl)
  → Go curl GET http://127.0.0.1:8101/fetch/https://www.books.com.tw/products/xxx
...
{
    "command": "open",
    "target": "http://127.0.0.1:8101/fetch/https://search.books.com.tw/search/query/key/##searchkey##/cat/all",
    "value": "",
    "options": {}
}
...
{
    "command": "open",
    "target": "http://127.0.0.1:8101/fetch/https://search.books.com.tw/search/query/key/##key1##/cat/all",
    "value": "",
    "options": {}
}
...
{
    "command": "open",
    "target": "http://127.0.0.1:8101/fetch/https://search.books.com.tw/search/query/key/##searchkey##/cat/all/page/##page##",
    "value": "",
    "options": {}
}
```
...
```bash
# 搜尋頁（curl_cffi 直接過）
curl -s http://127.0.0.1:8101/fetch/https://search.books.com.tw/search/query/key/python/cat/all | head -20

# 詳細頁（自動 fallback 到 Browser）
curl -s http://127.0.0.1:8101/fetch/https://www.books.com.tw/products/0011043725 | head -20
```
